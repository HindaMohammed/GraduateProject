...
<body>
    ...
    <div class="page-wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="blog-left.php">Blog left sidebar</a></li>
                                    <li><a href="blog-fulwidth.php">Blog fullwidth</a></li>
                                    <li class="menu-item-has-children">
                                        <a href="#">Blog details</a>
                                        <ul class="sub-menu">
                                            <li><a href="blog-single.php">Blog details right sidebar</a></li>
                                            <li><a href="blog-single-left.php">Blog details left sidebar</a></li>
                                            <li><a href="blog-single-fluid.php">Blog details fullwidth</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
        ...
        <!-- team-area-start -->
        <div class="team-area ">
            <div class="team-wrap section-padding">
                <div class="container">
                    <div class="row">
                    ...
                    <div class="col col-xs-12">
                        <div class="team-grids clearfix">
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="team.php">Devin Robertson</a></h3>
                                    <p>CEO & Founder</p>
                                </div>
                            </div>
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="team.php">Rickey Goodman</a></h3>
                                    <p>team</p>
                                </div>
                            </div>
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="team.php">Jean Washington</a></h3>
                                    <p>team</p>
                                </div>
                            </div>
                        </div>
