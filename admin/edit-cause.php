...
if(isset($_POST['edit'])) {
  ...
  $sql = "UPDATE causes SET title = '$title', image = '$new_name',	description = '$description', goal = '$goal' WHERE id = $id";
...
?>
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          <lable>Goal</lable>
          <input type="number" name="goal" value="<?= $data['goal'] ?>" class="form-control" />
        </div>
